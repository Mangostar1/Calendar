//componente day
let test = document.getElementById("test-calendar");//esta variable estara presente en el calendar.js - calendar-container en produccion
let containerDay = document.getElementById("container-Day");//esta variable se declara desde el calendar.js tambien
...
export function hourDayComponent(element) {
    let hourDay = [{
        hour: "00:00 hrs"}, 
        {hour: "01:00 hrs"}, 
        {hour: "02:00 hrs"}, 
